...
| # | Bước | Agent | Status | Step file | Hoàn thành lúc |
|---|------|-------|--------|-----------|-----------------|
| 2.1 | Viết TDD: chốt field `UninstallBeforeInstall`, vị trí checkbox UI, thứ tự gọi trong `DoInstallAsync`, SignalR progress bước mới, quyết định lưu DB Settings | Tech Lead | ✅ | `steps/STEP-2.1-tech-lead-tdd.md` | 2026-08-20 14:05 |
